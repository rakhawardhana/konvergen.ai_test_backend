...
router.post('/createTask', authenticationMiddleware, checkAdmin, multer.single('datasets'), taskController.create); // create task and upload zip
router.patch('/editTask/:id', authenticationMiddleware, checkAdmin, multer.single('datasets'), taskController.editTask ) //  edit task and dataset
...
router.get('/downloadDataset/:dataset', taskController.downloadDataset) // download dataset
